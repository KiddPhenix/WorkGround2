...

{
  ...
  const headwearLayer = host.querySelector<HTMLImageElement>(".agent-icon > img.agent-icon__layer:nth-child(2)");
  ok(Boolean(headwearLayer?.src.endsWith(".png")), "second layer is PNG headwear");
