...
eq(perfWithBreadcrumbs.message.includes("ancillary jobs open-topic tab-x ms=524"), true, "visible performance payload includes breadcrumb evidence");
eq(perfWithBreadcrumbs.message.includes("--- breadcrumbs ---"), false, "performance payload avoids duplicate breadcrumb sections");
