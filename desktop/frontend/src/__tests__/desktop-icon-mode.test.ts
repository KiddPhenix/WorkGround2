...
assert.match(anchorImageRule, /animation:\s*desktop-icon-anchor-keepalive 3600s ease-in-out infinite/, "the anchor image keeps a very slow compositor transform active while the widget is idle");
