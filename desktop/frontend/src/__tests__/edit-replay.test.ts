...
eq(
  replaySubmitText("hidden session context\nvisible prompt @.WorkGround2/attachments/a.png", "visible prompt @[a.png](.WorkGround2/attachments/a.png)", "updated prompt @[a.png](.WorkGround2/attachments/a.png)", "updated prompt @.WorkGround2/attachments/a.png"),
  "hidden session context\nupdated prompt @.WorkGround2/attachments/a.png",
