...
export const DEFAULT_THEME_STYLE: ThemeStyle = "iris";
const DEFAULT_THEME: Theme = "auto";

const THEME_KEY = "WorkGround2-theme";
const STYLE_KEY = "WorkGround2-theme-style";
...
function syncNativeWindowBackground(theme: Theme): void {
  ...
  } else if (currentThemeStyle === "iris") {
    // Iris dark: canvas #08090c → RGB(8,9,12).
    runtime.WindowSetBackgroundColour(8, 9, 12, 255);
  } else {
    // Dark shell: matches graphite --bg (#090a0c).
