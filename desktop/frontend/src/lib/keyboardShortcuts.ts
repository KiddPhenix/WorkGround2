...
const SHORTCUTS_STORAGE_KEY = "WorkGround2.customShortcuts";
const SHORTCUTS_CHANGED_EVENT = "WorkGround2:shortcuts-changed";
...
export const SHORTCUT_DEFINITIONS: readonly ShortcutDefinition[] = [
  ...
  {
    action: "widgetMode.toggle",
    section: "view",
    labelKey: "shortcuts.action.widgetModeToggle",
    descriptionKey: "shortcuts.desc.widgetModeToggle",
    defaults: modCombo("m"),
    preventDefault: true,
    allowInEditable: true,
  },
