...
const FONT_FAMILY_KEY = "WorkGround2-font-family";
const CUSTOM_FONT_KEY = "WorkGround2-font-family-custom";
const MONO_FONT_FAMILY_KEY = "WorkGround2-mono-font-family";
const CUSTOM_MONO_FONT_KEY = "WorkGround2-mono-font-family-custom";
