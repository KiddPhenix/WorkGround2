...
const DM = "__WorkGround2_MATH_DISPLAY__";
const IM = "__WorkGround2_MATH_INLINE__";
const LB = "__WorkGround2_LATEX_LINEBREAK__";
const ED_BASE = "WorkGround2ESCAPEDDOLLAR";
const DOLLAR = "&#36;";
...
function unusedPlaceholderPrefix(s: string): string {
  let prefix = "__WorkGround2_PROTECTED_CODE__";
  let n = 0;
  while (s.includes(prefix)) {
    n += 1;
    prefix = `__WorkGround2_PROTECTED_CODE_${n}__`;
  }
  return prefix;
}
