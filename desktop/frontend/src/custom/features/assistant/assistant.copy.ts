...
const en: typeof zh = {
  ...
  awake: "Awake", paused: "Paused", archived: "Archived", continueWork: "Let it continue", queued: "Recorded and queued. The assistant will handle it in the background.", inputRecorded: "Your input is recorded", assistantUnderstanding: "Understanding…", assistantReplying: "Assistant is replying", liveReplyWaiting: "Waiting for the live reply…", understood: "Understood", arrangedWork: "Arranged {n} items of work", replied: "Replied", youSaid: "You told the assistant",
  ...
  sessionPurpose: "Run purpose", sessionStatus: "Status", sessionUpdated: "Updated", sessionActions: "Actions",
  sessionOpen: "Open session", sessionCancel: "Stop",
