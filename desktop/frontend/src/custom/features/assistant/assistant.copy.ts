...
const zh = {
  ...
  channels: "推广渠道",
	...
	unknownValue: "未知",
	minute: "分钟",
  noChannels: "还没有推广渠道。配置 Discourse 后，助手可以在逐次审批后发帖或回复。",
  addChannel: "新增渠道",
  channelName: "渠道名称",
  ...
  templatePromoDesc: "连接 Discourse 社区，逐次审批外发，并根据真实效果持续改进。",
  phase4Preview: "阶段 4",
...
const en: typeof zh = {
  ...
  templatePromoDesc: "Connect Discourse communities, approve every outbound action, and improve from real results.", phase4Preview: "Phase 4", routinePreview: "It will create these routines",
