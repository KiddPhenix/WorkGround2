...
####
## WorkGround2 per-user NSIS installer.
##
...
##      forces the user back to %LOCALAPPDATA%\Programs\WorkGround2 even if they had
##      moved the install to a different drive (e.g. D:\Tools\WorkGround2); the silent
...
!define WorkGround2_DEFAULT_INSTALLDIR "$LOCALAPPDATA\Programs\${INFO_PRODUCTNAME}"
...
InstallDir "${WorkGround2_DEFAULT_INSTALLDIR}" # Per-user install location (no admin rights required).
...
####
!macro WorkGround2.writeUninstaller
    ...
    # user back to %LOCALAPPDATA%\Programs\WorkGround2 even if they had moved
    # the install to a different drive (e.g. D:\Tools\WorkGround2). The auto-
...
!macro WorkGround2.deleteUninstaller
...
fallback:
   StrCpy $INSTDIR "${WorkGround2_DEFAULT_INSTALLDIR}"
done:
FunctionEnd
...
Section
    ...
    !insertmacro WorkGround2.writeUninstaller
SectionEnd
...
Section "uninstall"
    ...
    !insertmacro WorkGround2.deleteUninstaller
