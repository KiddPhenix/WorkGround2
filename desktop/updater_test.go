...
func TestSaveCachedUpdateMarksEvaluateDownloaded(t *testing.T) {
	...
	asset := update.Asset{
		URL:    "https://dl.WorkGround2.io/desktop-v9.9.9/WorkGround2-linux-amd64.tar.gz",
		Size:   int64(len(data)),
...
func TestExtractBinary(t *testing.T) {
	...
	tw := tar.NewWriter(gz)
	files := map[string][]byte{"README": []byte("ignore me"), "WorkGround2-desktop": want}
	...
	got, err := extractBinary(buf.Bytes(), "WorkGround2-desktop")
	if err != nil {
