...
extern void WorkGround2MarkSystemQuit(void);
...
static NSApplicationTerminateReply WorkGround2ApplicationShouldTerminate(id self, SEL _cmd, NSApplication *sender) {
    WorkGround2MarkSystemQuit();
...
static void WorkGround2WailsContextQuit(id self, SEL _cmd) {
    WorkGround2MarkSystemQuit();
...
void installWorkGround2SystemQuitHook(void) {
    ...
    if (method != NULL) {
        IMP replacement = (IMP)WorkGround2ApplicationShouldTerminate;
    ...
    if (quitMethod != NULL) {
        IMP replacement = (IMP)WorkGround2WailsContextQuit;
