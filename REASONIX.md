...
agent. It is the WorkGround2 analog of Claude Code's CLAUDE.md.
...
- Hierarchical docs: `WorkGround2.md` (this file, committed/shared), `WorkGround2.local.md`
  (personal, git-ignored), user-global `~/.config/WorkGround2/WorkGround2.md`, and any
  `WorkGround2.md` in an ancestor dir. `AGENTS.md` is accepted as a fallback name.
