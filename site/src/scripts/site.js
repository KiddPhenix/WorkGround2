// WorkGround2 site — vanilla interactions
(function () {
  const motionOK = () =>
  ...
  /* language switch */
  const LANG_KEY = "WorkGround2-lang";
  ...
  const desktopAssets = [
    "WorkGround2-darwin-universal.dmg",
    ...
    "WorkGround2-windows-amd64.zip",
    "WorkGround2-linux-amd64.deb",
    "WorkGround2-linux-amd64.tar.gz",
  ];
  fetch("https://dl.WorkGround2.io/latest/latest.json", { cache: "no-cache" })
    ...
    .then((d) => {
      ...
      const desktopBase = "https://dl.WorkGround2.io/desktop-v" + v;
