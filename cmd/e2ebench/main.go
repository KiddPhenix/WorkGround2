...
func main() {
	flag.Usage = func() {
		fmt.Fprintf(flag.CommandLine.Output(), "e2ebench — WorkGround2 end-to-end benchmark.\n\n")
	...
	bin := flag.String("bin", "WorkGround2", "path to the WorkGround2 binary")
...
func render(results []result) string {
	...
	fmt.Fprintf(&b, "## 🤖 WorkGround2 e2e benchmark\n\n")
