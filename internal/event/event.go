...
const (
	...
	GuardianAssessment
	// TaskMemoryUpdated carries the controller-owned, session-scoped task
	// briefing. Frontends reject stale revisions.
	TaskMemoryUpdated
...
// TaskMemory is a factual, recoverable briefing for returning to a session.
// Each source names the typed origin of its corresponding value.
type TaskMemory struct {
	SessionKey     string `json:"sessionKey,omitempty"`
	Goal           string `json:"goal,omitempty"`
	Current        string `json:"current,omitempty"`
	NextStep       string `json:"nextStep,omitempty"`
	GoalSource     string `json:"goalSource,omitempty"`
	CurrentSource  string `json:"currentSource,omitempty"`
	NextStepSource string `json:"nextStepSource,omitempty"`
