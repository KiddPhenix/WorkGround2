...
func v2FrozenFields(name string, fields []string) []string {
	addendum := map[string]map[string]bool{
		...
		"WorkInput":                  {"customSpec": true, "extra": true, "error": true, "source": true, "updatedBy": true, "readyForStart": true},
		"SubmitWorkInputRequest":     {"extra": true, "deferStart": true},
		...
		"TaskV2View":                 {"sessionRef": true, "skillName": true},
		"InputRequestedPayload":      {"customSpec": true},
		"InputDraftSavedPayload":     {"extra": true, "readyForStart": true, "affectedTaskIds": true},
