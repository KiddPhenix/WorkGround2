...
func TestComposeAppendsAfterBase(t *testing.T) {
	base := "BASE PROMPT"
	set := &Set{Docs: []Source{{Path: "/p/WorkGround2.md", Scope: ScopeProject, Body: "Use tabs."}}}
	got := Compose(base, set)
...
func TestDiscoverPrecedenceOrder(t *testing.T) {
	...
	mustWrite(t, filepath.Join(user, "WorkGround2.md"), "USER LEVEL")
	mustWrite(t, filepath.Join(proj, "WorkGround2.md"), "PROJECT LEVEL")
	mustWrite(t, filepath.Join(proj, "WorkGround2.local.md"), "LOCAL LEVEL")
...
func TestDiscoverDecodesGB18030PrimaryDoc(t *testing.T) {
	...
	body := "# 项目约定\n\n始终使用中文回答。"
	if err := os.WriteFile(filepath.Join(project, "AGENTS.md"), fileencoding.Encode(body, fileencoding.GB18030), 0o644); err != nil {
		t.Fatal(err)
	}
...
func TestImportResolution(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "WorkGround2.md"), "Top line\n@shared.md\nBottom line")
...
func TestImportResolutionRejectsEscapes(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "WorkGround2.md"), "Top\n@/abs/path.md\n@~/secret.md\n@../secret.md\nBottom")
...
func TestImportCycleDoesNotHang(t *testing.T) {
	...
	mustWrite(t, filepath.Join(proj, "WorkGround2.md"), "@a.md")
...
func TestImportDiamondAndCycle(t *testing.T) {
	...
	mustWrite(t, filepath.Join(projCycle, "WorkGround2.md"), "@cycle1.md")
