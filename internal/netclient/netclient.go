// Package netclient builds HTTP clients and proxy resolvers that share WorkGround2's
...
// NewHTTPClient returns an HTTP client with WorkGround2 proxy settings applied.
