...
// $LC_ALL / $WorkGround2_LANG. Unknown locales return "" so DetectLanguage falls
...
// TestDetectLanguagePriority verifies override beats env and that WorkGround2_LANG
...
func TestDetectLanguagePriority(t *testing.T) {
	...
	t.Setenv("WorkGround2_LANG", "en")
	if got := DetectLanguage(""); got != "en" {
		t.Errorf("WorkGround2_LANG=en overriding LANG=zh: got %q, want en", got)
	}
