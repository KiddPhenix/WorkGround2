-- WorkGround2 Community forum. Identity comes from id.WorkGround2.io; this DB holds
-- forum content plus the anti-abuse state (trust levels, flags, silences).
-- Apply: wrangler d1 execute WorkGround2-forum --remote --file=schema.sql
...
CREATE TABLE IF NOT EXISTS members (
  email          TEXT PRIMARY KEY,              -- lowercased id.WorkGround2.io identity
