...
<header><a class="brand" href="https://WorkGround2.io">${LOGO}</a><a class="brand" href="https://WorkGround2.io">WorkGround2</a><span class="crumb">/ ${esc(crumb)}</span>${LANG_SWITCH}${nav ? `<span class="nav">${nav}</span>` : ""}</header>
