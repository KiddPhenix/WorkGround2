-- Apply: wrangler d1 execute WorkGround2-crash --remote --file=schema.sql
...
-- Legacy local auth — superseded by id.WorkGround2.io identity + the `access`
...
-- password, verification) lives in id.WorkGround2.io; this only maps email → role.
