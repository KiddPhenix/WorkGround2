-- Unify dashboard auth onto id.WorkGround2.io: dashboard access is now a per-email
...
-- Apply: wrangler d1 execute WorkGround2-crash --remote --file=migrate-access.sql
...
-- admins/viewers keep their access when they next sign in via id.WorkGround2.io.
