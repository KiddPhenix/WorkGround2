# Contributing to WorkGround2

Thank you for your interest in contributing to WorkGround2! This guide covers
...
```bash
git clone https://github.com/KiddPhenix/WorkGround2.git
cd WorkGround2
go build ./cmd/WorkGround2    # builds the CLI binary
...
| `internal/memory` | WorkGround2.md hierarchy + auto-memory |
...
WorkGround2 treats high prompt-cache hit rate as product behavior. Changes that
