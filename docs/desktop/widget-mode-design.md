...
- 按钮、状态、分页、队列、占位符、aria、Auto workspace、路由原因和 40 条运行态轮播文案全部本地化。
...
- 2026-07-16 多语言：WidgetMode 接入 Desktop i18n，补齐简中、繁中、英文系统文案和各 40 条运行态短句。后端新增稳定语义 code，旧中文 snapshot/receipt 继续通过 fallback 映射显示；用户与助手内容保持原文。
