...
- Keep WorkGround2 cache-first: stable prompt bytes stay stable across turns, while
...
WorkGround2 treats saved memory as a synthesis cache rather than as a raw transcript
cache.
